...
const Destinations = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <motion.section 
        className="bg-gradient-to-r from-travel-blue to-travel-blue text-white py-20"
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Explore 60 Amazing Destinations
          </motion.h1>
          <motion.p 
      ...
      {/* Destinations Grid */}
      <motion.section 
        className="py-20 bg-gradient-to-b from-white to-travel-light-blue"
        variants={sectionVariants}
        initial="hidden"
        animate="visible"
      >

      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-4xl font-bold text-travel-blue mb-2">{reviews.length}+</div>
        ...
        <div className="container mx-auto px-4">
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {reviews.map((review) => (
                <Card key={review.id} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 relative">

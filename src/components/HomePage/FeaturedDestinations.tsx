  ...
  const destinations = [
    {
      ...
      rating: 4.9,
      description:
        "The City of Light awaits with its iconic landmarks and romantic atmosphere.",
    },
    {
      name: "Dubai, UAE",
      image: dubaiImage,
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Explore our most popular destinations and create memories that last a
            lifetime
          </p>
        </motion.div>
              ...
              <Card className="group overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <CardContent className="p-6">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <h3 className="text-lg font-semibold text-travel-blue">
                      {destination.name}
                    </h3>
                  </div>
